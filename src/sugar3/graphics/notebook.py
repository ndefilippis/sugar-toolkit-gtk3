...
This class creates a Gtk.Notebook() widget supporting
...
class Notebook(Gtk.Notebook):
	'''
	Notebook class that creates a Gtk.Notebook. It is possible to set
    ...
    def do_set_property(self, pspec, value):
        '''
        Implementaion method. Use notebook.props to set properties.
        '''
    ...
    def add_page(self, text_label, widget):
        ...
        Args:
			...
			widget (.. :class:`Gtk.Widget`): widget to be used as contents of current page
        '''
